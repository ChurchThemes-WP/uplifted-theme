...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'resurrect-entry-full resurrect-person-full' ); ?>>
...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'resurrect-entry-short resurrect-person-short' ); ?>>
