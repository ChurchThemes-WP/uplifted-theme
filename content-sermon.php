...
if ( is_singular( get_post_type() ) ) :
	...
	if ( $player_request ) {
		...
		add_action( 'wp_footer', 'resurrect_sermon_player_scroll' );

		function resurrect_sermon_player_scroll() {
...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'resurrect-entry-full resurrect-sermon-full' ); ?>>
					...
					<ul id="resurrect-sermon-full-buttons" class="resurrect-list-buttons">
						...
						if ( $video_player && 'audio' == $show_player ) : // have video player but currently showing audio
							?><li id="resurrect-sermon-full-video-player-button">
								<a href="?player=video">
									...
									<?php _e( 'Show Video Player', 'resurrect' ); ?>
								</a>
							</li><?php
						endif;
						...
						if ( $audio_player && 'video' == $show_player ) : // have audio player but currently showing video
							?><li id="resurrect-sermon-full-audio-player-button">
								<a href="?player=audio">
									...
									<?php _e( 'Show Audio Player', 'resurrect' ); ?>
								</a>
							</li><?php
						endif;
						...
						if ( $video_download_url ) :
							?><li id="resurrect-sermon-full-video-download-button">
								<a href="<?php echo esc_url( $video_download_url ); ?>" title="<?php echo esc_attr( __( 'Download Video', 'resurrect' ) ); ?>">
									<span class="resurrect-button-icon <?php resurrect_icon_class( 'video-download' ); ?>"></span>
									<?php _e( 'Save Video', 'resurrect' ); ?>
								</a>
							</li><?php
						endif;
						...
						if ( $audio_download_url ) :
							?><li id="resurrect-sermon-full-audio-download-button">
								<a href="<?php echo esc_url( $audio_download_url ); ?>" title="<?php echo esc_attr( __( 'Download Audio', 'resurrect' ) ); ?>">
									<span class="resurrect-button-icon <?php resurrect_icon_class( 'audio-download' ); ?>"></span>
									<?php _e( 'Save Audio', 'resurrect' ); ?>
								</a>
							</li><?php
						endif;
						...
						if ( $pdf_download_url ) :
							?><li id="resurrect-sermon-full-pdf-download-button">
								<a href="<?php echo esc_url( $pdf_download_url ); ?>" title="<?php echo esc_attr( __( 'Download PDF', 'resurrect' ) ); ?>">
									<span class="resurrect-button-icon <?php resurrect_icon_class( 'pdf-download' ); ?>"></span>
									<?php _e( 'Save PDF', 'resurrect' ); ?>
								</a
							></li><?php
						endif;
...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'resurrect-entry-short resurrect-sermon-short' ); ?>>
