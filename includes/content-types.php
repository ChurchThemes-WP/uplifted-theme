 ...
 * List page templates in order of priority for uplifted_sidebar_enabled() and ctfw_redirect_archives_to_pages().
 *
 ...
 */
function uplifted_update_content_types( $content_types ) {

	// Add page templates to existing content types
	$content_types['sermon']['page_templates']		= array( 'sermons.php' );
	$content_types['event']['page_templates']		= array( 'events-upcoming.php', 'events-past.php' );
...
add_filter( 'ctfw_content_types', 'uplifted_update_content_types' );
