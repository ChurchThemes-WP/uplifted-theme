 ...
 * Register sidebars
 *
 * Also see uplifted_sidebar_restrictions() below to restrict which widgets a sidebar allows.
...
function uplifted_register_sidebars() {
  ...
  register_sidebar( array(
	...
	register_sidebar( array(
		...
		'name'			=> _x( 'Homepage Slider', 'widget area', 'uplifted' ),
		'description' 	=> __( 'Add CT Slide widgets to show in the homepage slider.', 'uplifted' ),
		'before_widget'	=> '',
		'after_widget'	=> '',
		'before_title' 	=> '',
		'after_title' 	=> '',
	...
	register_sidebar( array(
		...
		'name'			=> _x( 'Homepage Highlights', 'widget area', 'uplifted' ),
		'description' 	=> __( 'Add CT Highlight widgets to show on the homepage by the slider (two can be shown).', 'uplifted' ),
		'before_widget'	=> '',
		'after_widget'	=> '',
		'before_title' 	=> '',
		'after_title' 	=> '',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Page Sidebar', 'uplifted' ),
		'description' 	=> sprintf(
								__( 'These widgets show on the side of pages using the default template.', 'uplifted' ),
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Sermons Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of sermon pages.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Events Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of event pages.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'People Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of people pages.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Locations Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of locations content.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Gallery Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of gallery pages.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Blog Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of blog content.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Contact Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of the contact page.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
	...
	register_sidebar( array(
		...
		'name'			=> __( 'Search Sidebar', 'uplifted' ),
		'description' 	=> __( 'These widgets show on the side of search results.', 'uplifted' ),
		'before_widget'	=> '<aside id="%1$s" class="uplifted-widget uplifted-sidebar-widget %2$s">',
		'after_widget'	=> '</aside>',
		'before_title' 	=> '<h1 class="uplifted-widget-title">',
		'after_title' 	=> '</h1>',
...
add_action( 'widgets_init', 'uplifted_register_sidebars' );
 ...
 * The framework receives this data via the uplifted_sidebar_widget_restrictions filter.
 *
 ...
 */
function uplifted_sidebar_widget_restrictions( $restrictions ) {
...
add_filter( 'ctfw_sidebar_widget_restrictions', 'uplifted_sidebar_widget_restrictions' );

/**
 * Widget sidebar restrictions
 *
 * Restrictions based on which sidebars a widget allows or disallows itself to be used in.
 * The framework receives this data via the uplifted_widget_sidebar_restrictions filter.
 *
 ...
 * @return array Restrictions configuration
 */
function uplifted_widget_sidebar_restrictions( $restrictions ) {
...
add_filter( 'ctfw_widget_sidebar_restrictions', 'uplifted_widget_sidebar_restrictions' );
 ...
 */
function uplifted_sidebar_enabled() {
	...
	if ( is_active_sidebar( uplifted_sidebar_id() ) ) {
	...
	return apply_filters( 'uplifted_sidebar_enabled', $enabled );
