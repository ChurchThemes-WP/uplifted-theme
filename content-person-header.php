	...
	<div class="resurrect-entry-title-meta">
		...
		<?php if ( $position ) : ?>
			<ul class="resurrect-entry-meta">
				<li class="resurrect-person-position resurrect-icon-content">
		...
		<?php if ( $phone ) : ?>
			<ul class="resurrect-entry-meta">
				<li class="resurrect-person-phone resurrect-icon-content">
		...
		<?php if ( $email || $urls ) : ?>
			...
			<ul class="resurrect-entry-meta">
				...
				<?php if ( $email ) : ?>
				<li class="resurrect-person-email resurrect-icon-content">
