...
<header class="resurrect-entry-header resurrect-clearfix">
	...
	<div class="resurrect-entry-title-meta">
		...
		<ul class="resurrect-entry-meta">
			...
			<li class="resurrect-entry-date resurrect-icon-content">
			...
			<?php if ( $speakers = get_the_term_list( $post->ID, 'ctc_sermon_speaker', '', __( ', ', 'resurrect' ) ) ) : ?>
				<li class="resurrect-entry-byline resurrect-sermon-speaker resurrect-icon-content">
			...
			<?php if ( $topics = get_the_term_list( $post->ID, 'ctc_sermon_topic', '', __( ', ', 'resurrect' ) ) ) : ?>
				<li class="resurrect-entry-category resurrect-sermon-topic resurrect-icon-content">
			...
			<?php if ( $books = get_the_term_list( $post->ID, 'ctc_sermon_book', '', __( ', ', 'resurrect' ) ) ) : ?>
				<li class="resurrect-entry-category resurrect-sermon-book resurrect-icon-content">
			...
			<?php if ( resurrect_show_comments() ) : ?>
				<li class="resurrect-entry-comments-link resurrect-icon-content">
